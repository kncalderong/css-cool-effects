  ...
  return (
    ...
    >
      <div
        ref={blobRef}
        id='blob'
        className=' absolute bg-white h-[34vmax] aspect-square left-1/2 top-1/2  rounded-full bg-gradient-to-r from-emerald-200 from-0%  to-indigo-400  to-100% opacity-80 animate-rotateBlobEffect'
      ></div>
      <div
        id='blur'
      ...
      <h1
        ref={textRef}
        className='font-spaceMono text-white cursor-pointer uppercase z-[3]'
        style={{
